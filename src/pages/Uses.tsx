...
const categories: Category[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Affinity Designer', description: 'Vector and layout work without the subscription — reach for it on quick jobs where Illustrator is overkill.', tag: 'design' },
      ...
      { name: 'DaVinci Resolve', description: 'Colour grading and heavier edits — the node-based colour page is unmatched for wedding films.', tag: 'video' },
