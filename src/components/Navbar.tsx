...
function LiveClock() {
  ...
  return (
    <span className="text-xs text-[#acbac4] tabular-nums">
    ...
    <div className="fixed bottom-5 left-4 right-4 z-50 flex justify-center pointer-events-none">
      <nav
        ...
        style={{
          ...
          boxShadow: '0 8px 40px rgba(0,0,0,0.5), inset 0 1px 0 rgba(255,255,255,0.06), inset 0 -1px 0 rgba(0,0,0,0.2)',
        }}
      >
        {/* Top row: name + clock + socials */}
        <div
        ...
        >
          <NavLink
            to="/about"
            className="text-sm font-medium text-[#e1d9bc] hover:text-[#f0f0db] transition-colors duration-150"
          >
            amrlhakimii
          </NavLink>
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="https://github.com/amrlhakimii" target="_blank" rel="noopener noreferrer" aria-label="GitHub"
              className="text-[#acbac4] hover:text-[#e1d9bc] transition-colors duration-150">
        ...
        {/* Bottom row: emoji nav — evenly spaced */}
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                `flex items-center justify-center w-8 h-8 rounded-lg text-base transition-all duration-150 ${
                  isActive
                    ? 'bg-[#f0f0db]/10 text-[#f0f0db] scale-110'
                    : 'text-[#acbac4] hover:text-[#e1d9bc] hover:bg-white/[0.05]'
                }`
              }
            >
              {emoji}
